...
yay -S cava pulseaudio-control lf jq tty-clock-git backlight_control cbonsai plata-theme pulseaudio-control ttf-all-the-icons sl speedtest-cli --noconfirm
